...
namespace Biblioteca
{
    internal class Producto
    {
        ...
        public static string MostrarProducto(Producto producto)
        {
            ...
            sb.AppendLine(String.Format("Marca: {1}", producto.GetMarca()));
            sb.AppendLine(String.Format("codigo de barras: {1}", (string)producto));
            sb.AppendLine(String.Format("precio: {1}", producto.GetPrecio()));
            return sb.ToString();
        }
        ...
        {
            bool flag = true;
            if (productoA.marca == productoB.marca && productoA.codigoDeBarra == productoB.codigoDeBarra)
            {
                flag = false;
            }
            return flag;
